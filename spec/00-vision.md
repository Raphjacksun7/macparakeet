...
- Stable v0.8.6 is the current user-facing DMG. The train adds meeting import
  ...
  label after stop (status only; recordings were already saved). 0.8.6 also keeps
  the Sonoma Parakeet encoder off ANE.
